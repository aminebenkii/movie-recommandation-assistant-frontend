...
export default function IntroPage() {
  ...
  return (
    <div className="h-dvh flex items-center justify-center flex-col gap-8 text-center px-6 bg-gradient-to-br from-gray-50 to-gray-100 text-gray-800 font-[Manrope]">
      <h2 className="pb-2 text-3xl sm:text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-600 drop-shadow-md">
        {title}
      </h2>
      ...
      <button
        ...
        className="mt-2 px-6 py-3 bg-amber-700 text-white rounded-full text-sm sm:text-base font-semibold hover:bg-amber-800 transition-all shadow-md"
      >
        {button}
      </button>
    </div>
